...
router = Router()
router.include_routers(start_router, user_router, admin_router, game_router, salary_router, fuel_router, trailer_router, org_router, businesses_router, casino_router, betting_router, insurance_router)
