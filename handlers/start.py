...
async def cmd_start(message: Message):
    text = (
        ...
        "👤 <code>!моя_работа</code> — моя профессия и доступные действия\n"
        "🚫 <code>!уволиться</code> — уволиться\n"
        "💰 <code>!зп @user1 @user2 ...</code> — выплатить зарплату за сессию (админ)\n"
        "💵 <code>!изменить_зп Название сумма</code> (админ)\n\n"
        "━━ 🔹 <b>ДЕЙСТВИЯ В СЕССИИ</b> ━━\n"
        "🚛 <code>!доставка</code> — совершить доставку (дальнобойщик)\n"
        "💀 <code>!дело</code> — провернуть криминальное дело (криминал)\n"
        "🔍 <code>!расследование</code> — провести расследование (полиция/юристы)\n\n"
        ...
        "🏷 <code>!продать ID цена</code> — выставить игрокам\n"
        "🚫 <code>!снять_продажу ID</code> — убрать из продажи\n\n"
